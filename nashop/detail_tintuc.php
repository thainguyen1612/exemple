...
<?php 
$id=$_GET['id'];
$result = mysql_query("SELECT * FROM thoisu where id_ts='$id'");
...
<span style="text-transform:inherit; text-align:right;">Chi tiết</span><br /><?php echo $rowcn['noidung']?></td>
...
?>
<div id="..." >
<h1 style="background:#0F6;" style="color:#60F;"> Cac Tin Tuc Khac</h1>
<?php 
$result = mysql_query("SELECT * FROM thoisu ");
while($rowc = mysql_fetch_array($result))
{
	?>
    <p > >><?php echo $rowcn['tieude']?></p>
    <?php
}
?>
                       </p>
