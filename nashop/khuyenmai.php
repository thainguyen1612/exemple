			...
			<div id="content">
				<div class="post">
					<p>
                        ...
                        <tr>            
    <?php 
$result = mysql_query("SELECT * FROM tinkm");
while($rowcn=mysql_fetch_array($result))
{?>
<table width="600" border="0" cellspacing="2" cellpadding="2">
<tr>
<td width="161" height="170"><img src="<?php echo $rowcn['anh_km']?>" width="140" height="180"/> </td>
<td width="225" height="170"><a href="#" style="color:#CF0; font-size:16px"><?php echo $rowcn['ten_km']?></a><br/><?php echo $rowcn ['chitiet']?><br/>
<a>Giá bán: <?php echo $rowcn['giaban'] ?>.000 Vnd</a><br/>
</td>
